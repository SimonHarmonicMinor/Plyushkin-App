...
@Setter(PROTECTED)
@Getter
public class IncomeCategory extends AbstractCategory<IncomeNoteCategoryNumber, IncomeCategory> {
    ...
    public static IncomeCategory create(IncomeNoteCategoryNumber id,
                                        String name,
                                        WalletId walletId,
                                        UserId whoCreated) {
